...
static const uint8_t usbd_desc_cfg[USBD_DESC_LEN] = {
	...
	TUD_CDC_DESCRIPTOR(USBD_ITF_CDC_0_COM, USBD_STR_CDC, USBD_CDC_0_EP_CMD,
		USBD_CDC_CMD_MAX_SIZE, USBD_CDC_0_EP_OUT, USBD_CDC_0_EP_IN,
		USBD_CDC_IN_OUT_MAX_SIZE),

#if CFG_TUD_CDC > 1
	TUD_CDC_DESCRIPTOR(USBD_ITF_CDC_1_COM, USBD_STR_CDC, USBD_CDC_1_EP_CMD,
